...
- **Plugin slash commands** — `/handoff create`, `/handoff resume`, `/handoff prepare` for compatible Hermes runtimes.
...
- **Automatic handoff trigger policy** — `AUTOMATIC_HANDOFF_TRIGGER_POLICY.md`.
